...
##########################################################################################################################################
# mean values less than 6  data

res_mean=list()
res_dists_mean=list()
res_gof_dists_mean=list()
res_kgof_dists_mean=list()
res_param_mean=list()
...
for ( i in 1:length(res_pooled_mean_poor)) {
  ...
  for ( jj in idlist ) {
    outfilepdf=paste0("Plot_under","_",paste0(as.character(res_names[i]),"_dists_mean.pdf"))
    outfilepng=paste0("Plot_under","_",paste0(as.character(res_names[i]),"_dists_mean.png"))
  ...
  res_kgof_dists_mean[[i]]=c(kgof_fw$D.obs,kgof_fw$p.value,
                             kgof_fexp$D.obs,kgof_fexp$p.value,
                             kgof_flnor$D.obs,kgof_flnor$p.value);
}
...
res_kgof_dists_mean_poor_df=data.frame(myco=names(res_pooled_mean_poor),do.call("rbind",res_kgof_dists_mean))
...
saveRDS(res_dists_mean,"res_dists_mean.rds")
saveRDS(res_dists_mean_more,"res_dists_mean_more.rds")

saveRDS(res_gof_dists_UB,"res_gof_dists_UB.rds")
saveRDS(res_gof_dists_LB,"res_gof_dists_LB.rds")
saveRDS(res_gof_dists_mean,"res_gof_dists_mean.rds")
saveRDS(res_gof_dists_mean_more,"res_gof_dists_mean_more.rds")

saveRDS(res_kgof_dists_UB,"res_kgof_dists_UB.rds")
saveRDS(res_kgof_dists_LB,"res_kgof_dists_LB.rds")
...
XLConnect::writeWorksheetToFile("fitparams_UB.xls",res_kgof_dists_UB_df,"kgof_dists_UB")
XLConnect::writeWorksheetToFile("fitparams_UB.xls",res_gof_dists_UB_df,"gof_dists_UB")
...
XLConnect::writeWorksheetToFile("fitparams_mean.xls",res_kgof_dists_mean_poor_df,"kgof_dists_mean_only")
XLConnect::writeWorksheetToFile("fitparams_mean.xls",res_gof_dists_mean_poor_df,"gof_dists_mean_only")


XLConnect::writeWorksheetToFile("fitparams_mean.xls",res_summary_mean_more_df,"res_summary_mean")
XLConnect::writeWorksheetToFile("fitparams_mean.xls",res_param_mean_more_df,"res_param_mean")
XLConnect::writeWorksheetToFile("fitparams_mean.xls",res_kgof_dists_mean_more_df,"kgof_dists_mean")
XLConnect::writeWorksheetToFile("fitparams_mean.xls",res_gof_dists_mean_more_df,"gof_dists_mean")
